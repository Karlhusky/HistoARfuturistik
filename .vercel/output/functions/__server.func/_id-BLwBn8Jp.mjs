...
import { n as materiList, t as Route } from "./_id-Dix4mgQF.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_id-BLwBn8Jp.js
  ...
  `;
		this.config.targets.forEach((t) => {
			...
			el.addEventListener("targetLost", () => {
				if (t._locked && el.object3D) requestAnimationFrame(() => {
	...
	dispose() {
		...
		const sceneRoot = this.q("arSceneRoot");
		const sceneEl = sceneRoot?.querySelector("a-scene");
		try {
